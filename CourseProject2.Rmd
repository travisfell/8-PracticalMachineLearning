...
traincor <- findCorrelation(cor(train[,1:45]), cutof = .8, verbose = FALSE) #leave off classe column for now
...
validationPredGBM <- predict(trainGBM, validMod, type = "raw")
validationPredGBM$finalModel
confusionMatrix(validation$classe, validationPredGBM)
